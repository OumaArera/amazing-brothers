/**
 * Generic placeholder for unimplemented caregiver pages.
 * Replace with real page component when building each feature.
 */
import DashboardLayout from '../../layouts/DashboardLayout';
import Button from '../../components/ui/Button';
import { useNavigate } from 'react-router-dom';

const CaregiverPlaceholder = ({ title, icon, description }) => {
  ...
  return (
    <DashboardLayout pageTitle={title}>
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-6">
        ...
        <Button variant="ghost" onClick={() => navigate('/caregiver')}>← Back to Dashboard</Button>
      </div>
    </DashboardLayout>
  );
};

export default CaregiverPlaceholder;